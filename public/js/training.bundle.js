...
var _recompose = __webpack_require__(29);

var _EventApp = __webpack_require__(37);
...
var FILTER_NAMES = exports.FILTER_NAMES = ['region', 'startDate', 'localized_address_display'];
...
var generateDropdownOnChange = function generateDropdownOnChange(filterNames) {
  return filterNames.reduce(function (acc, filterKey) {
    acc[filterKey + 'OnSelect'] = function (_ref) {
...
var enhance = (0, _recompose.compose)((0, _recompose.withStateHandlers)({
  ...
  applyFilter: function applyFilter(_ref2) {
    var selectedFilters = _ref2.selectedFilters;
    return function () {
      return {
        appliedFilters: _extends({}, selectedFilters)
      };
    };
  }
})));

var App = enhance(_EventApp2.default);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(4);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(11);var _assign=__webpack_require__(3);var emptyFunction$1=__webpack_require__(2);var EventListener=__webpack_require__(12);var getActiveElement=__webpack_require__(13);var shallowEqual=__webpack_require__(9);var containsNode=__webpack_require__(14);var focusNode=__webpack_require__(15);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(25);var camelizeStyleName=__webpack_require__(27);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _changeEmitter = __webpack_require__(31);
...
var _EventbriteEmbed = __webpack_require__(48);

var _EventbriteEmbed2 = _interopRequireDefault(_EventbriteEmbed);
...
var getEventIdsFromFilter2 = function getEventIdsFromFilter2(filters) {
  ...
  var allFiltersEmpty = !Object.values(filters).some(Boolean);
  if (allFiltersEmpty) {
    return null;
  }
...
var getEventIdsFromFilter = function getEventIdsFromFilter(_ref) {
  var region = _ref.region;

  return window.eventsData.filter(function (eventData) {
    return eventData.region === region;
  }).map(function (x) {
    return x.id;
  });
};
...
var getEventbriteEmbed = function getEventbriteEmbed(id) {
  return _react2.default.createElement(
    'li',
    { key: id },
    _react2.default.createElement(_EventbriteEmbed2.default, { id: id })
  );
};

var createDropdownOptions = function createDropdownOptions(keyName) {
  var regionList = new Set(window.eventsData.map(function (eventData) {
    return eventData[keyName];
  }));
  return [].concat(_toConsumableArray(regionList)).map(function (region) {
    return {
      value: region,
      label: region
    };
...
var EventApp = function EventApp(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'ul',
      null,
      eventsId && eventsId.map(getEventbriteEmbed)
    )
  );
};
	...
	createClass(Value, [{
		...
		value: function renderRemoveIcon() {
			...
			return _react2.default.createElement('span', { className: 'Select-value-icon',
				...
				onTouchStart: this.handleTouchStart,
				onTouchMove: this.handleTouchMove }, '\xD7');
		}
	}, {
		key: 'renderLabel',
...
var Select$1 = function (_React$Component) {
   ...
   */
			...
			if (this.props.multi) {
				return valueArray.map(function (value, i) {
					return _react2.default.createElement(ValueComponent, {
						...
						value: value
					}, renderLabel(value, i), _react2.default.createElement('span', { className: 'Select-aria-only' }, '\xA0'));
				});
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			var ariaOwns = (0, _classnames2.default)((_classNames = {}, defineProperty(_classNames, this._instancePrefix + '-list', isOpen), defineProperty(_classNames, this._instancePrefix + '-backspace-remove-message', this.props.multi && !this.props.disabled && this.state.isFocused && !this.state.inputValue), _classNames));
			...
			if (this.props.disabled || !this.props.searchable) {
				...
				var _ariaOwns = (0, _classnames2.default)(defineProperty({}, this._instancePrefix + '-list', isOpen));
			...
			return _react2.default.createElement('div', { className: className, key: 'input-wrap' }, _react2.default.createElement('input', _extends({ id: this.props.id }, inputProps)));
		}
	}, {
		key: 'renderClear',
		...
		value: function renderOuter(options, valueArray, focusedOption) {
			...
			return _react2.default.createElement('div', { ref: function ref(_ref5) {
					return _this9.menuContainer = _ref5;
				}, className: 'Select-menu-outer', style: this.props.menuContainerStyle }, _react2.default.createElement('div', { ref: function ref(_ref4) {
		...
		value: function render() {
			...
			return _react2.default.createElement('div', { ref: function ref(_ref7) {
					return _this10.wrapper = _ref7;
				},
				className: className,
				style: this.props.wrapperStyle }, this.renderHiddenField(valueArray), _react2.default.createElement('div', { ref: function ref(_ref6) {
...
function defaultChildren(props) {
	return _react2.default.createElement(Select$1, props);
}
...
var AsyncCreatableSelect = function (_React$Component) {
	...
	createClass(AsyncCreatableSelect, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(Async, this.props, function (_ref) {
				var ref = _ref.ref,
				    asyncProps = objectWithoutProperties(_ref, ['ref']);

				var asyncRef = ref;
				return _react2.default.createElement(CreatableSelect, asyncProps, function (_ref2) {
					var ref = _ref2.ref,
...
exports.Async = Async;
exports.AsyncCreatable = AsyncCreatableSelect;
exports.Creatable = CreatableSelect;
exports.Value = Value;
exports.Option = Option;
exports.defaultMenuRenderer = menuRenderer;
exports.defaultArrowRenderer = arrowRenderer;
exports.defaultClearRenderer = clearRenderer;
exports.defaultFilterOptions = filterOptions;
...
var AutosizeInput = function (_Component) {
	...
	_createClass(AutosizeInput, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('div', { className: this.props.className, style: wrapperStyle }, this.renderStyles(), _react2.default.createElement('input', _extends({ id: this.state.inputId }, inputProps, { ref: this.inputRef })), _react2.default.createElement('div', { ref: this.sizerRef, style: sizerStyle }, sizerValue), this.props.placeholder ? _react2.default.createElement('div', { ref: this.placeHolderSizerRef, style: sizerStyle }, this.props.placeholder) : null);
		}
	}]);
...
var EventbriteEmbed = function EventbriteEmbed(_ref) {
  var id = _ref.id;
...
exports.default = EventbriteEmbed;
